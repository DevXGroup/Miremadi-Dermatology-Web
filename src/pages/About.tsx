                ...
                <div className="text-center max-w-5xl mx-auto mb-16">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-500 dark:text-slate-400">
                            Board Certified Dermatologist & Pathologist • 57+ Years of Experience
                        </p>
                    </motion.div>
                </div>
                    ...
                    <div className="lg:col-span-7 space-y-8">
                        ...
                        >
                            ...
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                                Dr. Arjang K. Miremadi is a board certified Dermatologist and Pathologist (AP-CP) and a certified dermatopathologist who maintains an active practice as well as a teaching status in both Dermatology and Pathology. His <strong>57+ years of experience</strong> in the medical field brings patients the finest in skin treatment, correction, and care.
                            </p>
